    ...
    const fetchAccountDetails = async () => {
      try {
        if (accountType === "guide") {
          ...
          setImageCert1(
            hisCertificates[0]
              ? `http://localhost:3000/${hisCertificates[0]}`
              : ""
          );
          setImageCert2(
            hisCertificates[1]
              ? `http://localhost:3000/${hisCertificates[1]}`
              : ""
          );
          setImageCert3(
            hisCertificates[2]
              ? `http://localhost:3000/${hisCertificates[2]}`
              : ""
          );
          setImageCert4(
            hisCertificates[3]
              ? `http://localhost:3000/${hisCertificates[3]}`
              : ""
          );
          setImageCert5(
            hisCertificates[4]
              ? `http://localhost:3000/${hisCertificates[4]}`
              : ""
          );
          setImageCert6(
            hisCertificates[5]
              ? `http://localhost:3000/${hisCertificates[5]}`
              : ""
          );
          setImageCert7(
            hisCertificates[6]
              ? `http://localhost:3000/${hisCertificates[6]}`
              : ""
          );
          setImageCert8(
            hisCertificates[7]
              ? `http://localhost:3000/${hisCertificates[7]}`
              : ""
          );
          setImageCert9(
            hisCertificates[8]
              ? `http://localhost:3000/${hisCertificates[8]}`
              : ""
          );
          setImageCert10(
            hisCertificates[9]
              ? `http://localhost:3000/${hisCertificates[9]}`
              : ""
          );
